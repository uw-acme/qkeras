...
class QMultiHeadAttention(Layer):
  ...
  def __init__(self,
    ...
    _kernel_constraint, _kernel_initializer = (
        get_auto_range_constraint_initializer(self.kernel_quantizer_internal,
                                              kernel_constraint,
                                              kernel_initializer))

    if use_bias:
        _bias_constraint, _bias_initializer = (
  ...
  def _build_from_signature(self, query, value, key=None):
    ...
    with tf_utils.maybe_init_scope(self):
      ...
      self._query_dense = qeinsum_dense.QEinsumDense(
          einsum_equation,
      ...
      self._key_dense = qeinsum_dense.QEinsumDense(
          einsum_equation,
          output_shape=_get_output_shape(output_rank - 1,
                                         [self._num_heads, self._key_dim]),
          bias_axes=bias_axes if self._use_bias else None,
      ...
      self._value_dense = qeinsum_dense.QEinsumDense(
          einsum_equation,
          output_shape=_get_output_shape(output_rank - 1,
  ...
  def _make_output_dense(self, free_dims, common_kwargs, name=None):
    ...
    return qeinsum_dense.QEinsumDense(
        einsum_equation,
  ...
  def _build_attention(self, rank):
    ...
    self._softmax = quantizers.quantized_softmax(axis=norm_axes)
